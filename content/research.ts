...
export const research: ResearchItem[] = [
  {
    ...
    body: [
      "The Florida Public Hurricane Loss Model (FPHLM) is a hurricane catastrophe model developed by a multi-university team and based at Florida International University. It is the public hurricane catastrophe model in the United States. Its methodology, assumptions, and results are open to scientific scrutiny. Commercial catastrophe models used in insurance remain proprietary.",
      "FPHLM estimates insured wind losses for personal and commercial residential property. In the public description of the model, the main components are wind hazard, engineering vulnerability, and actuarial insured loss. The Florida Office of Insurance Regulation has used the model as a benchmark when reviewing residential property insurance rates. This page does not restate the model’s equations or source code. Those stay with the FPHLM team.",
      "This lab’s project is catastrophe-bond pricing design on that public loss basis. The question is how a transparent hurricane loss model can inform the structure of a catastrophe bond: what loss the bond responds to, when it pays, and how the price relates to modeled loss. The contract design is in progress. A repository under the erfl-fiu organization will be linked here when the project code is public.",
    ],
    people: ["Dan Li"],
    papers: [],
    links: [
